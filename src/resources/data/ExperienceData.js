...
const ExperienceData = [
  ...
  //   EVERBRIDGE
  {
    ...
    timePeriod: "(8 months)",
    introText:
      "I joined Everbridge during as a full time coop student. I was hired to help out two different teams (Health and IT), which I thought would be challenging as I had to juggle a lot between projects and people. But this taught me some valuable skills like time management, commuincation and presentaion. Also, my initial recruitement period was for 6 months, but because of my performance and my contribution to some on going projects the recruitement period was extended for 2 more months.",
    details: [
      ...
      "Worked on various ROI models, Competitive, SWOT analysis to give the company an edge over competition.",
    ],
    width: "",
  },
  ...
  //   NORTHEASTERN UNIVERSITY
  {
    ...
    timePeriod: "(9 months)",
    introText:
      "This on-campus experience helped me a lot to grow as an individual. I started as a Facility Assistant and then later was promoted to Operational Supervisor. I got the oppportunity to interact to more than 100 people on a daily basis, understand what goes in running an insitute, experienced managing a team and bridged the gap between the higher management and the facility assistants.",
    details: [
      "Supervised all facility assistants, advocated patrons with their issues and handled any query related to the recreatinal center.",
      "Process all payments, membership and facility reservations.",
      "Recieved First-Aid as well as CPR certification and handled all the medical emergency situations.",
      "Managed schedules for all the facility assitants.",
    ],
    width: "",
  },
  ...
  //   PN TELECOM
  {
    ...
    introText:
      "After gaining some very important expereince in data analytics and leading various marketing campaigns, I decided to start my own startup which encapsulted various mobile service centers. Here, I understood the in's and out of running a business.",
    details: [
  ...
  //   NOKIA CARE
  {
    ...
    details: [
      "Data story teller, mining data from different data sources such as excel files, Pivot tables and online sources.",
      "Created various B2C Predictive and Descriptive analytics using Tableau.",
      "Lead a project for designing a database model.",
      "Redesigned inventory database, enhancing the efficiency and accuracy by 24%.",
  ...
  //   HP WORLD
  {
    ...
    details: [
      "Performed Data Profiling to learn more about user behavior and draw conclusion based on that.",
      ...
      "Partnered with sales department to specify customer requirements, offer technical solution and close the deal.",
